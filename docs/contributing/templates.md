...
- Take a look at [Templates](../language/introduction.md) // todo: fix link // and [Unique Matchers](../language/unique-matchers.md) Guideline for creating new template.

## Step 2 : Fork the Project

- Fork this Repository. This will create a Local Copy of this Repository on your Github Profile. Keep a reference to the original project in `upstream` remote.

![Nuclei Templates](../images/nuclei-templates.png)
